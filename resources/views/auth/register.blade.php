                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('high_school') ? ' has-error' : '' }}">
                            <label for="high_school" class="col-md-4 control-label">High School</label>

                            <div class="col-md-6">
                                <input id="high_school" type="text" class="form-control" name="high_school" value="{{ old('high_school') }}">
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            <label for="description" class="col-md-4 control-label">About me</label>
